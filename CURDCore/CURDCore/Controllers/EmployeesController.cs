...
namespace CURDCore.Controllers
{
    ...
    {
        private readonly CURDCoreContext _context;

        public EmployeesController(CURDCoreContext context)
        {
            _context = context;
        }
        ...
        {
            var cURDCoreContext = _context.Employee.Include(e => e.Department);
            return View(await cURDCoreContext.ToListAsync());
        }
